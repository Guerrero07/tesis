...
@Component({
  selector: 'app-alunmo-manager',
  templateUrl: './alunmo-manager.component.html',
  styleUrls: ['./alunmo-manager.component.css']
})
export class AlunmoManagerComponent implements OnInit {
